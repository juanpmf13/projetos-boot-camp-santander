...
class MainActivity : AppCompatActivity() {
    ...
    private fun pickImageFromGalery() {
        val intente = Intent(Intent.ACTION_PICK)
        intente.type = "image/*"
        startActivityForResult(intente, IMAGE_PICK_CODE)
        //setResult(IMAGE_PICK_CODE,intente)
    }

    private fun openCamera() {
        val values = ContentValues()
        values.put(MediaStore.Images.Media.TITLE, "nova foto")
        values.put(MediaStore.Images.Media.DESCRIPTION, "imagem capturada pela caramera")
